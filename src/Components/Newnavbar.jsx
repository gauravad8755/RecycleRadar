				...
				<Wrapper>
					<div className="flex items-center justify-between">
						...
						<div className="bg-gray-200 w-[40vw] items-center gap-2 flex px-4 py-3 rounded-2xl min-h-[5vh]">
							...
							<input
								type="text"
								className="bg-gray-200 font-poppins focus:border-none focus:outline-none"
								placeholder="Search"
							/>
						</div>
						...
						<div className="flex gap-4">
							<button className="text-md font-poppins font-medium border-2 p-3 rounded-3xl">
								Sign up
							</button>
							<button className="text-md font-poppins font-medium">
								Login
							</button>
